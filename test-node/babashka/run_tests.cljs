(ns babashka.run-tests
  "The squint entry point. squint has no test runner of its own, so this
  namespace runs the shared Node.js suite and sets the exit code."
  (:require [babashka.ffi-test]
            [clojure.test :as t]))
